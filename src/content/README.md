...
Edit these files for homepage content:

- `site.js`: page title, SEO text, navigation labels, publication group order, visitor map script.
...
- `services.js`: reviewer service list.

Images stay in `public/images/`.
